...
CAPNP_DECLARE_SCHEMA(c30b9813ccad40c2);
...
struct Person {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(c30b9813ccad40c2, 1, 2)
    #if !CAPNP_LITE
...
inline  ::int32_t Person::Reader::getId() const {
  return _reader.getDataField< ::int32_t>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}

inline  ::int32_t Person::Builder::getId() {
  return _builder.getDataField< ::int32_t>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}
inline void Person::Builder::setId( ::int32_t value) {
